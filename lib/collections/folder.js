...
module.exports = function(env) {
	...
	return {
		...
		//
		// https://docs.box.com/reference#folder-object
		// 
		...
		//								request a limited set of fields.
		//								
		// https://docs.box.com/reference#create-a-new-folder
		// 
		...
		//								request a limited set of fields.
		//								
		// https://docs.box.com/reference#copy-a-folder
		// 
		...
		//								
		// https://docs.box.com/reference#delete-a-folder
		// 
		...
		//								request a limited set of fields.
		//								
		// https://docs.box.com/reference#update-information-about-a-folder
		// 
		update: function(args, cb) {
			...
			if(parentId = typeof args.parentId === 'undefined'
					? false
					: env.toNumberOrThrow(args.parentId)
			) {
				body.parent = {
					"id": parentId
				};
