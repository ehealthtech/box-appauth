...
module.exports = function(env) {
	...
	return {
        ...
        // Here we want to *not* follow the redirect, and return the Location: header,
        // which is the download link we're seeking.
        //
        // @param args {Object}	Call signature
        // @param args.id {Integer}	The file id
        //
        ...
        getDownloadLink: function(args, cb) {
            ...
            request.get(env.prepare({
                ...
                //
                env.complete(cb)(err, r, r.request.response.headers.location);
            });
        },
